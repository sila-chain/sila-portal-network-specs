...
This document is the specification for the sub-protocol that supports on-demand availability of Verkle state data from the execution chain. Verkle trie is the upcoming structure for storing Sila state. See [SIP-6800](https://sips.sila.org/SIPS/sip-6800) for mode details.
